...
export default function Admin({ initialView = VIEW_DASHBOARD }) {
  ...
  return (
    ...
    >
      {toast && (
        <div
          className={`fixed top-4 right-4 z-50 px-6 py-3 rounded-xl shadow-2xl animate-in slide-in-from-top-4 duration-300 ${toast.type === "success"
